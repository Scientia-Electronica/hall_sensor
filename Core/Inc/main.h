...
#define HALL_SENSOR_VMINUS_Pin GPIO_PIN_10
#define HALL_SENSOR_VMINUS_GPIO_Port GPIOF
#define HALL_SENSOR_VPLUS_Pin GPIO_PIN_9
#define HALL_SENSOR_VPLUS_GPIO_Port GPIOF
